...
export function CuratedBoxCard({
  ...
  return (
    ...
    >
      {/* Header — title + integrated box total */}
      ...
      <div className="space-y-8 px-7 py-7 sm:px-8 sm:py-8">
        ...
        {/* iOS-style storage / fullness indicator */}
        <div className="space-y-3 rounded-2xl border border-zinc-100 bg-slate-50/80 p-4 sm:p-5 dark:border-zinc-800 dark:bg-zinc-950/80">
          ...
          >
            <div
              className="h-full rounded-full bg-navy transition-[width] duration-500 ease-out dark:bg-terracotta"
              style={{ width: `${clamped}%` }}
            />
          </div>
        ...
        {/* Optional greeting-card note */}
        {note ? (
          <div className="rounded-2xl border border-zinc-100 bg-white px-5 py-5 dark:border-zinc-800 dark:bg-zinc-900">
